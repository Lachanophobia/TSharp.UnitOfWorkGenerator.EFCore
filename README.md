...
# <img src="https://github.com/Lachanophobia/TSharp.UnitOfWorkGenerator.EFCore/blob/main/docs/uow.png" alt="Unit Of Work Generator" style="max-wdith:100%"/>
...
All classes are created as **partial** classes so you have the ability to extended them.  
 ...
 [![MIT license](https://img.shields.io/badge/License-MIT-blue.svg)](https://github.com/Lachanophobia/TSharp.UnitOfWorkGenerator.EFCore/blob/main/LICENSE/)
...
For versions >= 2.0.7 The issue has been patched. <br/>
For versions <= 2.0.2 The issue still remains. 
