...
## 1. Settings
You can create a json file in the root of your project with this name `uow.config.json` and overwrite the repositories namespace, add additional generic methods to execute stored procedures and use Guids as Identity Columns.
